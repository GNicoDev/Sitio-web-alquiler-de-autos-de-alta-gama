...
const mensajeSignIn = document.querySelector("#mensajeSignIn")
...
async function conectar(e) {
    ...
    if (existe) {
        ...
        mensajeSignIn.innerHTML = "Alguno de los datos son incorrectos. Si todavia no estas registrado te invitamos a hacerlo para poder usar nuestros servivios "
    }
